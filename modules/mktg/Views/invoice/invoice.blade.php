                    ...
                    <div class="panel invoice">
                        <div class="invoice-header">
                            ...
                            <address>
                                {{--{{ Auth::user()->username }}--}}
                                Prepared By : <br><br>
                                <strong class="black">{{--{{ $vendor_name }}--}}Name</strong><br>
                        ...
                        <div class="invoice-info row">
                            ...
                            <div class="size-15 col-sm-4" style=" border: 1px solid #fff;">
                                <table class="invoice-tbl-box">
                                    <tr><td><small>MR No.</small> </td><td>:</td><td>{{--{{ (isset($payment))?$payment->money_receipt_no:'' }}--}}0008</td></tr>
                                    <tr><td><small>Invoice No.</small> </td><td>:</td><td>{{--{{ (isset($transaction))?$transaction->invoice_no:'' }}--}}0909</td></tr>
                                </table>
                            </div>
