    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
            <div style="border-left: 3px dashed #404040;">
                ...
                <div class="form-group">
                    {!! Form::label('finishcoat', 'Finish coat :', ['class'=>'control-label col-sm-4 green-yellow']) !!}
                    <div class="col-sm-8">
                        {!! Form::select('finishcoat', array('00'=>'00','01'=>'01','02'=>'02','03'=>'03','04'=>'04','05'=>'05','06'=>'06'),Input::old('finishcoat'),['class' => 'form-control deeppink size-15','id'=>'', 'onchange'=>'myFunction()','required']) !!}
                    </div>
                </div>
            </div>
        </div>
