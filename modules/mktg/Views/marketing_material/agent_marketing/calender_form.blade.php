<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
            <div class="checkbox">
                <label class="green-yellow"><input name="size" type="checkbox" checked onclick="return false" > Size DL (210mm x 99mm </label><br>
                <label class="green-yellow"><input name="fullcolor" type="checkbox" checked onclick="return false" > Full colour print 1 side</label><br>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="checkbox">
