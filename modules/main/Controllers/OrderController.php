...
//        $data = DB::table('quote')->orderBy('id','DESC')->paginate(30);
        ...
        else
        {
            ...
            $data = Quote::with('relBusiness','relUser','relPropertyDetail')->where(['business_id'=> Auth::user()->business_id,'status'=>'quote-confirmed'])->orderBy('id','DESC')->paginate(10);
            //print_r($data); exit();
        }
...
//            dd($property_details);
    ...
    public function page_place_order_edit($quote_id, $quote_no)
    {
        //exit('0000000');
        $pageTitle = 'Place Order';
        //,$total,$gst,$total_with_gst
        ...
        #print_r($quote_property_image[0]['image_path']);exit;
        ...
        return view('main::order.place_order_update',[
            'pageTitle'=>$pageTitle,
            'quote_id'=>$quote_id,
            'quote_no'=>$quote_no,
            'property_detail_id'=>$property_detail_id,
