<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="col-sm-6">
            ...
            {!! Form::label('kinds', 'Kinds:', ['class'=>'green-yellow']) !!}
            {!! Form::select('kinds', array('00'=>'00','01'=>'01','02'=>'02','03'=>'03','04'=>'04','05'=>'05','06'=>'06'),Input::old('kinds'),['class' => 'deeppink select-inpt size-15','id'=>'stock', 'onchange'=>'myFunction()','required']) !!}
