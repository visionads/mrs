                ...
                <div class="panel">
                        <div class="panel-heading gray-bg">
                                ...
                                <a class="btn btn-primary btn-sm pull-right pop" data-toggle="modal" href="#addData" data-placement="left" data-content="click to add new Media">
                                        <strong><span class="glyphicon glyphicon-plus"></span> Add New Solution</strong>
                                </a>
                        </div>
                        ...
                        <div class="panel-body">
                                ...
                                <div class="">
                                        ...
                                        {!! Form::text('title', @Input::get('title')? Input::get('title') : null,['title'=>'Write your required solution type','id'=>'title','class' => 'form-control text-left','placeholder'=>'Title']) !!}
                                                ...
                                                @if(isset($data))
                                                        @foreach($data as $row)
                                                                <tr class="gradeX">
                                                                        ...
                                                                        <td>
                                                                                <a href="{{ route('solution-type-view', $row->id ) }}" class="btn btn-info btn-sm" data-placement="top" data-toggle="modal" data-target="#etsbModal" data-content="view"><i class="glyphicon glyphicon-eye-open"></i></a>
                                                                                <a href="{{ route('solution-type-edit', $row->id ) }}" class="btn btn-primary btn-sm" data-placement="top" data-toggle="modal" data-target="#etsbModal" data-content="update"><i class="glyphicon glyphicon-edit"></i></a>
                                                                                <a href="{{ route('solution-type-delete', $row->id) }}" class="btn btn-danger btn-sm" data-placement="top" onclick="return confirm('Are you sure to Delete?')" data-content="delete"><i class="glyphicon glyphicon-trash"></i></a>
                                                                        </td>
