        ...
        <div class="panel">
            ...
            <div class="panel-heading gray-bg">
                ...
                <a class="btn btn-primary btn-sm pull-right pop" data-toggle="modal" href="#addData" data-placement="left" data-content="click to add new Solution">
                    <strong><span class="glyphicon glyphicon-plus"></span>Add Print Material</strong>
                </a>
            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Add Print Material Informatons<span style="color: #A54A7B" class="user-guideline" data-content="<em>Must Fill <b>Required</b> Field.    <b>*</b> Put cursor on input field for more informations</em>"><font size="2"></font> </span></h4>
            </div>
            <div class="modal-body">
                {!! Form::open(['route' => 'store-print-material','class' => 'form-horizontal','id' => 'jq-validation-form', 'files'=>true]) !!}
                @include('admin::print_material._form')
                {!! Form::close() !!}
            </div> <!-- / .modal-body -->
        </div> <!-- / .modal-content -->
    </div> <!-- / .modal-dialog -->
