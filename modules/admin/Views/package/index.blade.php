        ...
        <div class="panel">
            ...
            <div class="panel-heading gray-bg">
                ...
                <a class="btn btn-primary btn-sm pull-right pop" data-toggle="modal" href="#addData" data-placement="left" data-content="click to add new Solution">
                    <strong><span class="glyphicon glyphicon-plus"></span>Add New Package</strong>
                </a>
            </div>
            ...
            <div class="panel-body">
                ...
                {!! Form::open(['method' =>'GET','route'=>'package-search']) !!}
                            ...
                            @foreach($data as $values)
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('delete-package', $values->id) }}" class="btn btn-danger btn-xs" data-placement="top" onclick="return confirm('Are you sure to Delete?')" data-content="delete"><i class="glyphicon glyphicon-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Add a Package<span style="color: #A54A7B" class="user-guideline" data-content="<em>Must Fill <b>Required</b> Field.    <b>*</b> Put cursor on input field for more informations</em>"><font size="2"></font> </span></h4>
            </div>
            <div class="modal-body">
                {!! Form::open(['route' => 'store-package','class' => 'form-horizontal','id' => 'jq-validation-form', 'files'=>true]) !!}
